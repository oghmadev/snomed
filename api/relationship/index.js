...
router.get('/children/direct', middleware.logRequest('relationship', relationship.getChildren.name), relationship.getDirectChildren)
router.get('/children', middleware.logRequest('relationship', relationship.getChildren.name), relationship.getChildren)
router.get('/parents/direct', middleware.logRequest('relationship', relationship.getParents.name), relationship.getDirectParents)
